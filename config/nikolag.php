    ...
    'connections' => [
        ...
        */
        'square' => [
            ...
            'access_token'   => env('SQUARE_TOKEN', 'EAAAEKUcfi8Y3KtrfgMtZxcyzFIebHcf8sxWzUpLyfXcbFiJA5Effcd0zUx6pivG'),
            ...
            */
            'order' => [
                'namespace'          => env('SQUARE_ORDER_NAMESPACE', '\App\Models\Front\Order'),
