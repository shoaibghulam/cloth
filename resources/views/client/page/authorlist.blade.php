...
@section('title', 'E-Book | Author Profile ')
...
@section('content')
		...
		<main class="inner-page-sec-padding-bottom">
			<div class="container">
				...
				@foreach($authorss as $authorprofile)
					...
					<div class="col-lg-4 col-sm-6">
						<div class="product-card">
							<div class="product-grid-content">
								...
								<h3><a>{{$authorprofile->shopname}}</a></h3>
								</div>
								<div class="product-card--body"> 
									<div class="card-image">
										<a href="{{route('authorsprofiledetails',['id'=>$authorprofile->id])}}"><img src='{{asset("uploads/vendors/".$authorprofile->image)}}' width="170px" height="170pxgit" alt=""></a>
							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									<div class="product-header">
										...
										<h3><a tabindex="0">{{$authorprofile->shopname}}</a></h3>
									</div>
									<article>
										<p></p>
									</article>
				...
				<div class="row pt--30">
					<div class="col-md-12">
						...
						{{$authorss->links('client.page.pagination')}}
