...
@section('title', 'E-Book | Authors Videos ')
				...
				<div class="breadcrumb-contents">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Authors Videos</li>
						</ol>
					</nav>
				</div>
			</div>
			...
			<div class="container">
							...
							<div class="product-grid-content">
								...
								<div class="product-card--body"> 
									<div class="card-image">
                                        ...
                                        <source src="{{asset("uploads/vendors/".$videolist->video)}}" type="video/mp4">
                                        <source src="{{asset("uploads/vendors/".$videolist->video)}}" type="video/ogg">
                                        Your browser does not support HTML5 video.
                                      </video>
                                        <!--<iframe width="320" height="240" src='{{asset("uploads/vendors/".$videolist->video)}}' frameborder="0"></iframe>-->
				...
				<div class="row pt--30">
					<div class="col-md-12">
						...
						{{$video->links('client.page.pagination')}}
