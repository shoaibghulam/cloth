...
@section('content')
		...
		<main class="inner-page-sec-padding-bottom">
			<div class="container">
									...
									<div class="card-image">
										...
										<div class="hover-contents">
											...
											<div class="hover-btns">
												...
												<a href="javascript:;" data-toggle="modal" data-target="#quickModal"
												class="single-btn">
							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									<div class="product-header">
										...
										<h3><a href="" tabindex="0">{{$book->title}}</a></h3>
									</div>
									<article>
									...
									<div class="btn-block">
										...
										<a href="javascript:;" class="card-link"><i class="fas fa-heart whishlist" data-id="{{$book->id}}"></i> Add To Wishlist</a>
										<a href="#" class="card-link"><i class="fas fa-random cart" data-id="{{$book->id}}" data-name="{{$book->name}}" data-image="{{$book->image}}" data-price="{{$book->price}}" data-discount="{{$book->discount}}"></i> Add To Cart</a>
									</div>
								</div>
							</div>
						</div>
				...
				<!-- Modal -->
				<div class="modal fade modal-quick-view abc" id="quickModal" tabindex="-1" role="dialog"
              ...
              "focusOnSelect": true
									...
									<div class="col-lg-7 mt--30 mt-lg--30">
										<div class="product-details-info pl-lg--30 ">
											<p class="tag-block tag">Tags: <a href="#"></a><a href="#"></a></p>
											<input type="hidden"  name="id" class="id" value="">

											<h3 class="product-title titles"></h3>
											<ul class="list-unstyled">
												<!-- <li>Ex Tax: <span class="list-value"> £60.24</span></li> -->
												<li>ISBN: <a href="#" class="list-value font-weight-bold publishers"></a>
												</li>
											...
											<div class="price-block">
												<span class="price-new price1"></span>
												<del class="price-old price2"></del>
											</div>
