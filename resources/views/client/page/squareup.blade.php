				...
				<div class="breadcrumb-contents">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Square</li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<div class="col-12">
						...
						<div class="checkout-form">
							<div class="row row-40">
								<div class="col-12">
									<h1 class="quick-title">Square</h1>
									<!-- Slide Down Trigger  -->
									...
									<div class="row">
										...
										<div class="col-12">
											<div class="checkout-cart-total">
												<h2 class="checkout-title">PAY WITH SQUARE</h2>
                        ...
                        @foreach($items as $carts)
												...
												@endforeach
												<button id="sq-creditcard" class="btn btn--primary w-100">Pay ${{$total}}</button>
