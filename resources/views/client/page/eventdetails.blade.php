...
@section('title', 'E-Book | Event Details ')
            ...
            <div class="container">
              ...
              "asNavFor": ".product-slider-nav"
                            ...
                            <div class="single-slide">
                                <img src='{{asset("uploads/events/".$details->image)}}' alt="">
                            </div>
              ...
              "focusOnSelect": true
                    ...
                    <div class="col-lg-7">
                        ...
                        <h3 class="product-title"></h3>
                            ...
                            <li>Event Name: <a class="list-value font-weight-bold">{{$details->eventname}}</a></li>
                            
                            <li>Description: <a class="list-value font-weight-bold">{{$details->description}}</a></li>
                            <!-- <li>Phone No: <span class="list-value"></span></li>
                            <li>Shop Name: <span class="list-value"></span></li> -->

                                {{-- <li>Reward P <span class="list-value"> 200</span></li> --}}
                                <!-- <li>Bio: <span class="list-value"></span></li> -->
                            </ul>
