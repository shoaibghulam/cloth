                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="{{asset('c-assets/image/products/product-1.jpg')}}"
                                                        alt="Compare Product"></a>
                                                <a href="#" class="category">Glasses</a>
                                                <a href="#" class="title">Rinosin Glasses</a>
                                            </td>
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="{{asset('c-assets/image/products/product-2.jpg')}}"
                                                        alt="Compare Product"></a>
                                                <a href="#" class="category">Glasses</a>
                                                <a href="#" class="title">Macro Melodi</a>
                                            </td>
                                            <td class="product-image-title">
                                                <a href="#" class="image"><img src="{{asset('c-assets/image/products/product-3.jpg')}}"
                                                        alt="Compare Product"></a>
                                                <a href="#" class="category">Glasses</a>
