							...
							<div class="product-grid-content">
								...
								<div class="product-card--body"> 
									<div class="card-image">
										<a href="{{route('productdetail',['book_id'=>$book->id])}}"><img src='{{asset("uploads/images/".$book->image)}}' width="170px" height="170pxgit" alt=""></a>
							...
							<div class="product-list-content">
								...
								<div class="product-card--body">
									...
									<div class="btn-block">
										...
										<a href="javascript:;" class="btn btn-outlined whishlist" data-id="{{$book->id}}">Add To Whishlist</a>
