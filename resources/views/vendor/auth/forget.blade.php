                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    ...
                                    <div class="card rounded-0 mb-0 px-2 py-1">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form action="{{ route('vendor.auth.forgetpassword-process') }}" method="post">
                                                @csrf
                                                ...
                                                <div class="float-md-left d-block mb-1">
                                                    <a href="{{route('vendor.auth.login')}}" class="btn btn-outline-primary btn-block px-75">Back to Login</a>
                                                </div>
