        ...
        <div class="navbar-container content">
          <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"></span><span class="user-status">{{Auth::guard('vendor')->user()->name}}</span></div><span><img class="round" src='{{asset("uploads/vendors/".Auth::guard("vendor")->user()->image)}}' alt="avatar" height="40" width="40"></span></a>
                <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="{{route('vendor.profile')}}"><i class="fa fa-pencil"></i> Edit Profile</a>
                  <div class="dropdown-divider"></div><a class="dropdown-item" href="{{route('vendor.change-password')}}"><i class="fa fa-sign-out"></i>Change Password</a>

                  <div class="dropdown-divider"></div><a class="dropdown-item" href="{{route('vendor.logout')}}"><i class="fa fa-sign-out"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class="nav-item">
            <a href="{{route('vendor.booklist')}}">
              <i class="fa fa-book"></i>
              <span class="menu-title" data-i18n="Order">Books</span>
            </a>
          </li> 
          <li class="nav-item">
            <a href="{{route('vendor.order.list')}}">
              <i class="fa fa-dollar"></i>
              <span class="menu-title" data-i18n="Order">Order</span>
            </a>
          </li>  
           <li class="nav-item">
            <a href="{{route('vendor.video')}}">
              <i class="fa fa-camera"></i>
              <span class="menu-title" data-i18n="Video">Video Portal</span>
            </a>
          </li>
           <li class="nav-item">
