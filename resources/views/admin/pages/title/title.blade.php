...
@section('store-title-active', 'active')
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form action="{{route('admin.title.process')}}" method="post">
                @csrf
                    <div class="card-body card-dashboard">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                <input type="hidden" name="id" @if(!empty($title)) value="{{$title->id}}" @endif> 
                                <input type="text" name="title" class="form-control" value="{{$title->title}}" placeholder="Enter Title">
