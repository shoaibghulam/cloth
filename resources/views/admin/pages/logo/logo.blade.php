        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Store Logo</h4>
                   
                    
                </div>
                <div class="card-content">
                   
                <form action="{{route('admin.logo.process')}}" method="post" enctype="multipart/form-data">
                @csrf
                    <div class="card-body card-dashboard">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                <input type="hidden" name="id" @if(!empty($logos)) value="{{$logos->id}}" @endif>
                                <input type="file" name="image" class="form-control" value="{{$logos->image}}" required>
