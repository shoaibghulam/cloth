        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Store Slider</h4>
                ...
                @csrf
                    <div class="card-body card-dashboard">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12 abc">
                                <div class="form-group">
                                <input type="hidden" name="id"> 
                                <input type="text" class="form-control" placeholder="Category Name" name="email">
...
<p>This is another paragraph.</p>
                        ...
                        <div class="row">
                           <div class="col-12 ">
                                <button type="button" class="btn btn-primary mr-1 mb-1 waves-effect waves-light float-right">Submit</button>
