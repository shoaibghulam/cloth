...
@section('store-terms-active', 'active')
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Store Term And Conditions</h4>
                   
                    
                </div>
                <div class="card-content">
                   
                <form action="{{route('admin.terms-information-process')}}" method="post">
                @csrf
                    <div class="card-body card-dashboard">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                            <label class="text-dark">Terms And Conditions</label>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                <input type="hidden" name="id" @if(!empty($term)) value="{{$term->id}}" @endif > 
                                <textarea name="term" class="form-control">{{$term->term}}</textarea>
